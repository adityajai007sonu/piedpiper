...
myApp.controller('homeCtrl', function($scope,$stateParams,$http,$location,Search) {
  $scope.list_areas = {
    ...
    $scope.services = [
    { title: 'Cloud image hosting Unlimited Storage Upload Images and share it on Facebook, Twitter, WhatsApp, Tumblr, Instagram or any other website you would like. ✔️NSFW Allowed (Dont forget to mark them as NSFW) ✔️Click About to view our contests to win money ❌No Pornographic images allowed', id: "Singing", img: '6.jpg' }
  ];
